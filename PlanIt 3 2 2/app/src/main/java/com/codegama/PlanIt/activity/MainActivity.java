...
public class MainActivity extends BaseActivity implements CreateTaskActivity.setRefreshListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Changes here by lama (fragment >> activity )
        calendar.setOnClickListener(view -> {
            Intent intent = new Intent(MainActivity.this, ShowCalendar.class);
            startActivity(intent);
        });

        //added by lama (Click tasks icon >> new activity that contain all tasks )
        ...
        class GetSavedTasks extends AsyncTask<Void, Void, List<Task>> {
            ...
            protected List<Task> doInBackground(Void... voids) {
                tasks = DatabaseClient
                        ...
                        .getAppDatabase()
                        .dataBaseAction()
                      //.getAllTasksList();      by lama
                        .getClosestTasks(); // Modify the database query to get closest tasks ordered by time
                return tasks;
            }
